    ...
    function () {
      async function fetchLiveFlightPrice() {
        ...
        try {
          ...
          if (!response.ok) {
            throw new Error(data.error || 'Could not fetch live flight price.');
          }
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    {[
                      ...
                      const value = opt[0] as FlightSort;
                      const label = opt[1];
                      const active = flightSort === value;
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    {[
                      ...
                      const value = opt[0] as StopsFilter;
                      const label = opt[1];
                      const active = stopsFilter === value;
